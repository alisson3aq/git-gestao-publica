				...
				<form action="<?php echo base_url() . $this->uri->segment(1); ?>/usuariosCadastrar/" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group form-group-lg">
    						<label for="documento" class="col-sm-2 control-label">Documento</label>
							    <div class="col-sm-3">
							      <input type="text" name="documento" class="form-control" id="documento" value="<?php echo $lista->documento; ?>" required="required" readonly="readonly"  placeholder="somente números" pattern="[0-9]+$" />
							    </div>
  						</div>
  						...
  						<div class="form-group form-group-lg">
    						<label for="nome" class="col-sm-2 control-label">Nome</label>
							    <div class="col-sm-9">
							      <input type="text" name="nome" class="form-control" id="nome" value="<?php echo $lista->nome; ?>" required="required" placeholder="Nome Completo">
							    </div>
  						</div>
