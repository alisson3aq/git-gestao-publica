		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="panel panel-default" style="padding: 0 0 0 1%;">
						<h4><strong>Protocolos encontrados</strong> <small class="hidden-xs hidden-sm"> - Consulta de Protocolos </small></h4>
				<a href="<?php echo base_url() . $this->uri->segment(1); ?>/consulta" class="btn btn-primary btn-xs" style="margin-bottom: 1%;">Refazer Consulta</a>
				</div>
